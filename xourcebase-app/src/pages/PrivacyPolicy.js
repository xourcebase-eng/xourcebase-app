      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="space-y-12">
            ...
            <motion.section variants={fadeInUp} className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md dark:shadow-gray-700/50">
              <div className="flex items-start space-x-4 mb-6">
                <UserCheck className="w-8 h-8 text-indigo-600 dark:text-indigo-400 mt-1 flex-shrink-0" />
            ...
            <motion.section variants={fadeInUp} className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md dark:shadow-gray-700/50">
              <div className="flex items-start space-x-4 mb-6">
                <Cookie className="w-8 h-8 text-indigo-600 dark:text-indigo-400 mt-1 flex-shrink-0" />
