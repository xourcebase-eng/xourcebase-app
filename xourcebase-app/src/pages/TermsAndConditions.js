          ...
          <div className="space-y-12">
            ...
            <motion.section variants={fadeInUp} className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md dark:shadow-gray-700/50">
              <div className="flex items-start space-x-4 mb-6">
                <Scale className="w-8 h-8 text-indigo-600 dark:text-indigo-400 mt-1 flex-shrink-0" />
            ...
            <motion.section variants={fadeInUp} className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md dark:shadow-gray-700/50">
              <div className="flex items-start space-x-4 mb-6">
                <Gavel className="w-8 h-8 text-indigo-600 dark:text-indigo-400 mt-1 flex-shrink-0" />
            ...
            <motion.section variants={fadeInUp} className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md dark:shadow-gray-700/50">
              <div className="flex items-start space-x-4 mb-6">
                <AlertTriangle className="w-8 h-8 text-indigo-600 dark:text-indigo-400 mt-1 flex-shrink-0" />
            ...
            <motion.section variants={fadeInUp} className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md dark:shadow-gray-700/50">
              <div className="flex items-start space-x-4 mb-6">
                <Globe className="w-8 h-8 text-indigo-600 dark:text-indigo-400 mt-1 flex-shrink-0" />
            ...
            <motion.section variants={fadeInUp} className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md dark:shadow-gray-700/50">
              <div className="flex items-start space-x-4 mb-6">
                <Mail className="w-8 h-8 text-indigo-600 dark:text-indigo-400 mt-1 flex-shrink-0" />
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Contact Information</h2>
              </div>
              <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                <p>For questions about these Terms, contact:</p>
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>Email:</strong> <a href="mailto:contact@xourcebase.com" className="text-indigo-600 dark:text-indigo-400 hover:underline">contact@xourcebase.com</a></li>
                </ul>
              </div>
            </motion.section>
          </div>
