...
import { ArrowUp, Mic, Users, Globe, GraduationCap, MessageCircle, Phone, ChevronDown, Crown, Download } from 'lucide-react';
...
const CommunicationSupportExcellence = () => {
  ...
  useEffect(() => {
    ...
    metaDesc.content = 'From communication to confidence — build your professional voice. Master interview skills, cultural awareness, and support excellence for IT roles with our 14-Day Interview Clearing Kit.';
    ...
    metaKeywords.content = 'communication training, interview preparation, support excellence, verbal skills, cultural awareness, IT interviews, professional voice, 14-day interview kit, STAR method, mock interviews';
    
    // Open Graph tags
    const ogTags = [
      { property: 'og:title', content: 'Communication & Support Excellence | XourceBase' },
      { property: 'og:description', content: 'From communication to confidence — build your professional voice. Ideal for IT professionals seeking to excel in interviews and workplace interactions with self-introduction mastery, resume guidance, and insider tips.' },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: 'https://xourcebase.com/communication-support' },
    ...
    const twitterTags = [
      ...
      { name: 'twitter:description', content: 'Master communication skills for interviews and professional success with hands-on training, 14-Day Interview Clearing Kit, and support from experienced mentors.' },
  ...
  const focusAreas = [
    { icon: Mic, title: 'Verbal Communication', description: 'Master clear articulation, voice modulation, and accent neutralization. Practice daily reading aloud, record and review for clarity, tone, and pace.' },
    { icon: Users, title: 'Interview Techniques', description: 'STAR method, Q&A mastery, and confidence building for IT roles. Prepare for common questions, mock interviews, and handling difficult situations with empathy.' },
    { icon: Globe, title: 'Cultural Awareness', description: 'Global workplace etiquette and cross-cultural communication skills. Learn polite phrases, greetings, holidays, and formal responses for international clients.' }
  ];
  ...
  const plans = [
    {
      ...
      whatYouGet: [
        { number: '1️⃣', phase: 'Foundation Phase – Basic Setup (Days 1-3)', items: [
        ...
        { number: '2️⃣', phase: 'Skill Building Phase – Core Essentials (Days 4-5)', items: [
        ...
        { number: '3️⃣', phase: 'Readiness Phase (Days 6-7)', items: [
    ...
    },
    {
      ...
      whatYouGet: [
        { number: '1️⃣', phase: 'Guidance Phase – Confidence Building (Days 1-4)', items: [
        ...
        { number: '2️⃣', phase: 'Performance Phase – Practice & Feedback (Days 5-7)', items: [
        ...
        { number: '3️⃣', phase: 'Enhancement Phase (Days 8-10)', items: [
    ...
    },
    {
      ...
      whatYouGet: [
        { number: '1️⃣', phase: 'Transformation Phase – Elite Skills (Days 1-5)', items: [
        ...
        { number: '2️⃣', phase: 'Mastery Phase – Advanced Tools (Days 6-9)', items: [
        ...
        { number: '3️⃣', phase: 'Sustain Phase (Days 10-12)', items: [
    ...
    },
    {
      ...
      whatYouGet: [
        { number: '', phase: 'Covers: Starter + Pro + Elite (Full 14-Day Elite Edition)', items: [
        ...
        { number: '', phase: 'Includes (Advanced Enhancements):', items: [
        ...
        { number: '', phase: 'Premium Support & Final Review:', items: [
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <motion.a
              ...
              className="inline-flex items-center bg-red-600 hover:bg-red-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg transform hover:scale-105 transition-all duration-300 space-x-3"
            >
            ...
            <motion.a
              ...
              className="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg transform hover:scale-105 transition-all duration-300 space-x-3"
            >
              <Download className="w-5 h-5" />
